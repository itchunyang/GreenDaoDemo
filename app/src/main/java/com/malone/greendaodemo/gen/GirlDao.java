package com.malone.greendaodemo.gen;
...
public class GirlDao extends AbstractDao<Girl, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Url = new Property(2, String.class, "url", false, "image");
    ...
    public Girl readEntity(Cursor cursor, int offset) {
        Girl entity = new Girl( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getBlob(offset + 3) // data
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Girl entity, int offset) {
        ...
        entity.setData(cursor.isNull(offset + 3) ? null : cursor.getBlob(offset + 3));
     }
